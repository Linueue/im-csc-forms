...
<div class="p-2 w-full overflow-x-auto">
    ...
    >
        {#snippet headerRows()}
            ...
            <Table.Head class="max-w-[25em]">Highest Education Level</Table.Head>
            <Table.Head class="max-w-[25em]">Title of Degree</Table.Head>
            <Table.Head class="max-w-[25em]">Employment Position</Table.Head>
        {/snippet}
        {#snippet bodyRows()}
