...
<div class="p-2 w-full overflow-x-auto">
    ...
    >
        {#snippet headerRows()}
            ...
            <Table.Head class="max-w-[25em]">Examination Date</Table.Head>
            <Table.Head class="max-w-[25em]">Employment Type</Table.Head>
            <Table.Head class="max-w-[25em]">School Name</Table.Head>
        {/snippet}
        {#snippet bodyRows()}
